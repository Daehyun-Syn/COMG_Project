                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left">
                                ...
                                <div class="mb-3">
                                    <input type="birth" class="form-control" placeholder="생년월일" aria-label="birth" aria-describedby="password-addon">
                                </div>
                                <div class="text-center">
                                    <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2">회원가입</button>
                                </div>
