                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">파일</th>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span class="text-secondary text-xs font-weight-bold"><input type="text" name="st_department" list="depList"><br></span>
                                        <datalist id="depList">
                                            <option value="융합프로젝트실습"></option>
                                            <option value="포트폴리오제작"></option>
                                            <option value="빅데이터분석실습"></option>
                                            <option value="파스타컴퓨팅실습활용"></option>
                                            <option value="빅데이터처리실습"></option>
                                            <option value="코로나 자가진단 키트"></option>

                                        </datalist>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold"><input type="file"></span>
                                    </td>
