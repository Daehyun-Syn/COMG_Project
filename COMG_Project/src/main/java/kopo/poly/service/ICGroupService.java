...
public interface ICGroupService {
    ...
    CGroupDTO getGroupUserCount(CGroupDTO gDTO) throws Exception;

    CGroupDTO getGroupSeq(CGroupDTO nDTO) throws Exception;

    int InsertGroupUserAdminInfo(CGroupDTO nDTO) throws Exception;

    CGroupDTO selectGroupUserSeq(CGroupDTO cDTO) throws Exception;

    int UpdateGroupMsg(CGroupDTO bDTO) throws Exception;
}
