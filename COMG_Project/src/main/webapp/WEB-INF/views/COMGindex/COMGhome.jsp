                        ...
                        <div class="card card-plain mt-8">
                            ...
                            <div class="card-body">
                                <form role="form" method="post" action="/COMG/joinLogic">
                                    ...
                                    <div class="mb-3">
                                        <input type="email" name="id" class="form-control" placeholder="이메일로 가입" aria-label="Email" aria-describedby="email-addon" required="required">
                                    </div>

                                    <div class="mb-3">
                                        <input type="password" name="pwd" class="form-control" placeholder="비밀번호" aria-label="Password" aria-describedby="password-addon" required="required">
                                    </div>

                                    <div class="mb-3">
                                        <input type="text" name="name" class="form-control" placeholder="이름" aria-label="Password" aria-describedby="password-addon" required="required">
                                    </div>

                                    <div class="mb-3">
                                        <input type="text" name="student_id" class="form-control" placeholder="학번" aria-label="StudentID" aria-describedby="password-addon" required="required">
                                    </div>
