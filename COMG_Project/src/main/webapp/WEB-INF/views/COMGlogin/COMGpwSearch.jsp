                        ...
                        <div class="card-body">
                            <form role="form text-left" method="post" action="/COMG/updatePassWord">
                                ...
                                <div class="mb-3">
                                    <table>
                                        <th style="width: 79.5%">
                                            <input type="email" name="id" id="id" class="form-control" placeholder="이메일" aria-label="Email" aria-describedby="email-addon" required="required">
                                        </th>
                                        <th><button id="code_send" type="button" class="btn bg-gradient-info w-100 my-1 mb-1" onclick="code_sending();" style="font-size: 75%">전송</button>
                                        </th>
                                ...
                                <div class="mb-3">
                                    <table>
                                        <th style="width: 79.5%">
                                            <input type="text" name="Certification_Number" id="Certification_Number" class="form-control" placeholder="인증번호" aria-label="key" aria-describedby="key" required="required">
                                        </th>
                                        <th><button id="code_check" type="button" class="btn bg-gradient-secondary w-100 my-1 mb-1" onclick="code_checking();" style="font-size: 75%">확인</button>
                                        </th>
