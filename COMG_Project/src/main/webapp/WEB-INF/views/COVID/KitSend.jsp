                ...
                <div class="card mt-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-info shadow-danger border-radius-lg pt-4 pb-3">
                            <h4 class="text-white font-weight-bold text-capitalize ps-3">검사 방법</h4>
                            <h6 class="text-white font-weight-bold text-capitalize ps-3">1. 시작하기 버튼을 먼저 눌러주세요 (처음 한번만 눌러주시면 됩니다)</h6>
                            <h6 class="text-white font-weight-bold text-capitalize ps-3">2. 검사할 키트 사진을 업로드해주세요</h6>
                            <h6 class="text-white font-weight-bold text-capitalize ps-3">3. 결과보기 버튼을 눌러주세요</h6>
                        </div>
                    </div>
                    <div class="card-body">
                        <input type="button" value="시작하기" class="btn bg-gradient-success w-100 my-4 mb-2" onclick="init()">
                        <div class="mb-3">
                            <div class="position-relative">
                                <a class="d-block shadow-xl border-radius-xl">
                                    <img src="#"  alt="covid_kit_img" class="img-fluid shadow border-radius-xl" id="uploadimage">
                                </a>
                            </div>
                            <br>
                            <div>
                                <label for="uploadkitimage" class="form-label">검사할 키트 사진을 업로드 해주세요.</label>
                                <input class="form-control" type="file"  id="uploadkitimage" name="uploadkitimage" onchange="prev_img(this)" accept="image/*"/>
                                <input class="hidden" id="group_seq" value="<%=group_seq%>">
                            </div>
                        ...
                        <div class="text-center">
                            <input type="button" value="결과보기" class="btn bg-gradient-success w-100 my-4 mb-2" onclick="predict()">
                        </div>
                    </div>
                </div>
            </div>
...
<!-- teachablemachine buttons -->
<script src="https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@1.3.1/dist/tf.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@teachablemachine/image@0.8/dist/teachablemachine-image.min.js"></script>
<script type="text/javascript" src="/teachable/teachable.js"></script>
</body>
