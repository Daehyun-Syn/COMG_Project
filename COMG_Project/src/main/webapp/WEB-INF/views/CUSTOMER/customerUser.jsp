				...
				<ui class="contacts">
					<li class="active">
						<div class="d-flex bd-highlight">
							<div class="img_cont">
								<img src="https://comgbucket.s3.ap-northeast-2.amazonaws.com/TG300-D02_img01.png" class="rounded-circle user_img">
				...
				<div class="card-body msg_card_body" id="talk">
					...
					<div class="d-flex justify-content-start mb-4">
						<div class="img_cont_msg">
							<img src="https://comgbucket.s3.ap-northeast-2.amazonaws.com/TG300-D02_img01.png" class="rounded-circle user_img_msg">
						</div>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		ws.onmessage = function (msg) {
			...
			var ss_name = '<%=(String)session.getAttribute("user_name")%>';
			...
			if (other == ss_name) {
				...
				var html = '';
				html += '<div class="d-flex justify-content-start mb-4"> <div class="img_cont_msg"> <img src="https://comgbucket.s3.ap-northeast-2.amazonaws.com/TG300-D02_img01.png" class="rounded-circle user_img_msg"> </div>';
				html += '<div class="msg_cotainer">' + message;
	...
	function send() {
		if (msg.value.trim() != '') {
			data.name = '<%=(String)session.getAttribute("user_name")%>'; //세션에 저장된이름
			data.msg = msg.value;
