            ...
            <div class="col-12 mt-4" >
                <div class="card mb-4">
                    <div class="card-header pb-0 p-3">
                        ...
                        <h6 class="mb-1">그룹 검색</h6>


                            <div class="search" style="float:right;">
                                <form id="searchForm" name="searchForm">
                                <input type="text" class="searchTerm" id="searchGroupName" name="searchGroupName" placeholder="그룹 이름을 입력하여 검색하세요" onkeyup="search_groupname()">
                        ...
                        <h4 class="text-sm">검색된 그룹 목록입니다.</h4>
