                        ...
                        <div class="table-responsive p-0">
                            ...
                            <div class="divTable">
                                ...
                                <div class="divTableBody">
                                    ...
                                    <div class="divTableRow" onclick="location.href='/COMG/AssignmentSubmitInfo?GroupSEQ=<%=group_seq%>&&AssignmentSEQ=<%=rList.get(i).getAssignment_room_seq()%>'" style="cursor: pointer">
                                        ...
                                        <%
                                            if (rList.get(i).getAssignment_feedback() != null){

                                        %>
                                        <button class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 btn-sm d-flex align-items-center justify-content-center" id="feedback" value="<%=rList.get(i).getAssignment_feedback()%>" onclick="getFeedBack(this);">
                                            <i class="fas fa-check"></i>
                                        </button>
                                        <%
                                            } else {
                                        %>
                                        <button class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 me-3 btn-sm d-flex align-items-center justify-content-center" ><i class="fas fa-ban"></i></button>
                                        <%
                                            }
                                        %>
                                    </div>
