            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left" method="post" action="/COMG/joinLogic" onsubmit="return userRegCheck(this)">
                                <div class="mb-3">
                                    <input type="text" name="name" id="name" class="form-control" placeholder="이름" aria-label="Name" aria-describedby="email-addon" required="required">
                                </div>
                                <div style="float: left; width: 78%">
                                    <input id="id" class="form-control" name="id" required="required" type="email" placeholder="이메일" />
                                </div>
                                <div style="float: right;">
                                    <button id="duplicate_check" class="btn bg-gradient-info w-100 " style="font-size: 75%; " type="button" onclick="id_check()">중복확인</button>
                                </div>
                                ...
                                <p id="check"></p>
                                <div class="mb-3">
                                    <input type="text" name="student_id" id="student_id" class="form-control" placeholder="학번" aria-label="StudentID" aria-describedby="password-addon" required="required">
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">회원가입</button>
                                </div>
                                <p class="text-sm mt-3 mb-0">이미 가입하셨나요? <a href="/COMG/login" class="text-dark font-weight-bolder">로그인하기</a></p>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    function id_check(){
        ...
        $.ajax({
            ...
            success: function(data){
                if(data == 0){
                    console.log("아이디 없음");
                    swal('아이디 중복확인', "중복된 아이디가 없습니다.", 'success');
                }else{
                    console.log("아이디 있음");
                    swal('아이디 중복확인', "동일한 아이디가 이미 존재합니다.", 'error');
                }
            },
            error: function (){
